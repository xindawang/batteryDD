...
public class UserManageService {
    ...
    public AdminEntity checkAdminIdNumber(String idNumber) {
        return usermanage.checkAdminIdNumber(idNumber);
    }

    public StaffEntity checkStaffidNumber(String idNumber) {

        return usermanage.checkStaffIdNumber(idNumber);
    }

    public TechnicianEntity checkTechnicianIdNumber(String idNumber) {

        return usermanage.checkTechnicianIdNumber(idNumber);
    }

    public TechnicianEntity checkTechnicianId(String technicianId) {

        return usermanage.checkTechnicianId(technicianId);
    }
