...
public class ImportResourceController {
    ...
    @RequestMapping(value = "/importCity1", method = RequestMethod.GET)
    String getCity1(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
