...
public interface indentAllocationMapper {
    ...
    //技师开工/收工
    @Update("update technician set iswork=#{state} where technician_id=#{technicianId}")
    boolean updateTechIsWork(@Param("technicianId") String technicianId, @Param("state") String state);
}
