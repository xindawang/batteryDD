...
CREATE TABLE `battery_price`  (
  ...
  CONSTRAINT `battery_price_batteery_ID_fk` FOREIGN KEY (`BATTERY_ID`) REFERENCES battery (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `battery_stock`  (
  ...
  CONSTRAINT `battery_stock_batteery_ID_fk` FOREIGN KEY (`BATTERY_ID`) REFERENCES battery (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `motocycle_type`  (
  ...
  CONSTRAINT `motocycle_type_batteery_ID_fk` FOREIGN KEY (`BATTERY_ID`) REFERENCES battery (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_allocation`  (
  ...
  CONSTRAINT `order_allocation_order_ID_fk` FOREIGN KEY (`ORDER_ID`) REFERENCES INDENT (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `order_evaluation`  (
  ...
  CONSTRAINT `order_evaluation_order_ID_fk` FOREIGN KEY (`ORDER_ID`) REFERENCES INDENT (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `receiving_confirmation`  (
  ...
  CONSTRAINT `receiving_confirmation_order_ID_fk` FOREIGN KEY (`ORDER_ID`) REFERENCES INDENT (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
