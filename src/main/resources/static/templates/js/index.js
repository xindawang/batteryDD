...
$(function () {
    ...
    if(role=='admin'){
        document.getElementById("admin-modify").href="adminOneselfInfo.html?loginName="+loginName;
    }
    if(role=="staff"){
        document.getElementById("staff-modify").href="staffInfoComplete.html?loginName="+loginName;
    }
